          ...
          <Grid margin = "20px auto" width = "50vw" key = {idx}>
            ...
            <TodoCard>
              ...
              <div style={{width : "20%", height : "30px", float : "left", margin : "5px auto"}}>
                ...
                {/* 수정버튼 */}
                <TodoImogi viewBox="0 0 24 24" height="1.8em" width="1.8em" onClick={() => {console.log("수정버튼입니다!")}}>
                  <path 
                ...
                {/* 완료버튼 */}
                <TodoImogi viewBox="0 0 24 24" height="2em" width="2em" onClick={() => {console.log("완료버튼입니다!")}}>
                  <path 
