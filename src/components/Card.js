...
const Card = () => {
  ...
  return (
    ...
    <React.Fragment>
      ...
      <Grid margin = "20px auto" width = "50vw">

        <TodoCard>
        {/* 체크 수정 삭제 */}

        <>
          <svg viewBox="0 0 24 24" height="2em" width="2em">
        ...
        <>
          <svg viewBox="0 0 24 24" height="1.8em" width="1.8em">
        ...
        <Text color ="#02343F" >투두투두투두투두</Text>
